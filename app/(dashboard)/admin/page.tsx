...
import { getAdminDashboardData } from "./_lib/admin-data"

export default async function AdminDashboard() {
  const { stats, progressByYear, recentActivity } = await getAdminDashboardData()
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      ...
      <div className="flex-1 p-6 space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <ProgressChart data={progressByYear} />
