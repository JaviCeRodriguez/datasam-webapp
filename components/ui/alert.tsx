  ...
  "relative w-full rounded-lg border border-neutral-200 px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-neutral-950 [&>svg~*]:pl-7 dark:border-neutral-800 dark:[&>svg]:text-neutral-50",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-yellow-500/50 text-stone-900 dark:border-yellow-500 [&>svg]:text-stone-900 dark:border-yellow-900/50 dark:text-stone-900 dark:dark:border-yellow-900 dark:[&>svg]:text-stone-900 bg-yellow-500/50",
        success:
